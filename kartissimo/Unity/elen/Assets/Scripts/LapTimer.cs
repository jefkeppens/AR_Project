...
public class LapTimer : MonoBehaviour
{
    ...
    public Text playerNameText; // Legacy Text for player name
    ...
    void Start()
    {
        ...
        // Display the player's name using StaticData
    ...
    // Update the player name UI
    private void UpdatePlayerNameUI()
    {
        if (playerNameText != null)
        {
            playerNameText.text = "Player: " + StaticData.playerName;
        }
        else
        {
            Debug.LogError("Player name Text component is not assigned!");
        }
    }

    private void UpdatePlayerRecordUI() {
        if (playerRecordText != null) {
            playerRecordText.text = "Overall record: " + StaticData.record + "s";
        }
    }
